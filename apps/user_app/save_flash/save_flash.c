...
#define CFG_USER_LED_LEDGTH_DATA 3 // id号
...
void read_flash_device_status_init(void)
{
    ...
    ret = syscfg_read(CFG_USER_SAVE_INFO_ID, (u8 *)(&save_flash_structure), sizeof(save_flash_t));
...
void save_user_data_area3(void)
{
    ...
    local_irq_disable(); // 禁用中断
    ret = syscfg_write(CFG_USER_SAVE_INFO_ID, (u8 *)(&save_flash_structure), sizeof(save_flash_t));
    local_irq_enable(); // 使能中断
